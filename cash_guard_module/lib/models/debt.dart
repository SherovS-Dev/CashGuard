enum DebtType {
  borrowed, // Мне должны (я дал в долг кому-то, мне должны вернуть)
  lent, // Я должен (я взял в долг у кого-то, я должен вернуть)
  credit, // Кредит от банка (я взял кредит, я должен вернуть)
}
